...
| Field  | Value |
| ------------- | ------------- |
| Purpose  | If you are doing the L4 course, select **Practice/Self Enablement** <br/> If you are delivering a PoC, select:<br/>**Proof-of-Concept** and inform the Sales opportunity.  |
