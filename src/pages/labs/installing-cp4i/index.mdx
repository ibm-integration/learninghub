...
1. The first service we will create is the Platform UI instance. You can use the following script:
```
...
1. Now you can deploy an instance of the Asset Repository using the following script:
```
scripts/05-asset-repo-inst-deploy.sh
```

2. Once the instance is deployed you will get an email. To confirm Asset Repo has been installed successfully you can use the following command:
```
