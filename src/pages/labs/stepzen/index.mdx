...
4. Accept the default values and click **Install** to complete the installation. If necessary enter the Windows administrator password (check with your lab owner).
