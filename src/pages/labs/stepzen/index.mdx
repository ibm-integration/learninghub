...
2. Open the <a href="" target="_blank">URL below</a> (1). And download the recommended node.js version.
```
https://nodejs.org
```
...
3. If you have a personal account, go ahead and log in. If you are using an account provided by your lab owner, log in with the user and password that you received.
