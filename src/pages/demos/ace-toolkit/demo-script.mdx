...
Select the **Assign** action (1). Under the **Properties** for the Assign action, enter “**Caramel Candy Bars**” for the name value (2).
...
Select the **Assign** action (1). Under the **Properties** for the Assign action, enter “**Request has been processed by Mapping Node**” for the name value.
...
Expand the **TEST_SERVER** directory under the **Independent Resources** folder (1) and double-click the **server.conf.yaml** file to open it in the IBM App Connect Enterprise text editor to the right.
...
Back to the *Integration Explorer* view, right-click the **TEST_SERVER** (1) and select **Restart** (2).
...
Back to the **getDepartment** subflow (1), open again the Transformation menu and drag and drop a **Compute** node (2).
...
Using the Project Explorer view, open the *HelperFiles* project and the **utils** folder, right click on the **Compute.esql** file (1) and select **Copy** (2).
...
On the **ShoppingListAPI** project, right click on the **utils** folder, and select **Paste** (2).
...
Enter **Bakery** as **department** name (1). Click **Send** (2).
...
Enter **$LocalEnvironment/REST/Input/Parameters/department="Candies"** in the *Filter pattern* field (1) and select **mapping** as the *Routing output terminal* (2). Then click **OK** (3).
...
Enter **$LocalEnvironment/REST/Input/Parameters/department="Snacks”** in the *Filter pattern* field (1) and select **compute** as the *Routing output terminal* (2). Then click **OK** (3).
...
Enter **$LocalEnvironment/REST/Input/Parameters/department="Bakery”** in the *Filter pattern* field (1) and select **java** as the *Routing output terminal* (2). Then click **OK** (3).
...
On the *New Bar file* dialog, type **shoppinglist** as the bar file name (1) and click **Finish** (2).
