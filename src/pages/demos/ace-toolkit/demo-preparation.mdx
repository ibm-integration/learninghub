...
Let’s create our IBM App Connect Enterprise as a Service trial now.
...
2.2 Select the best **AWS region** for your trial (1), define an **instance name** (e.g.: yourname-demo) (2) ands click **Continue** (3).
...
2.4 First time, you will see a Welcome to IBM App Connect Designer dialog. You are welcome to explore the options. Feel free to start a product tour(2). When done, **close** the Welcome dialog to access the IBM App Connect Designer home screen.
...
3.6 Start the **IBM App Connect Enterprise Toolkit** on your chosen platform.
...
In this demo, you will import a REST API documentation and reuse a pre-created ESQL file. These files will be available as HelperFiles Project in App Connect. Let's download and import it!

4.1 Now let’s download the Toolkit project that we will use in the demo. Open a **browser** and go to this <a href="https://github.com/ibm-integration/learninghub/blob/main/static/ace-toolkit-files/HelperFiles.zip" target="_blank">GitHub page</a>
...
4.7 Select **Project Interchange** (1) and click **Next** (2).

  ![](images/helper-files-7.png)

4.8 Select **HelperFiles.zip** (1) file that you downloaded in the first step. Verify **HelperFile project is checked** (2) and click **Finish** (3).

  ![](images/helper-files-8.png)

4.9 Great! You should see your HelperFiles in the Independent Resources group.

  ![](images/helper-files-9.png)

You are ready to present the demo!  Take a breath and happy selling!
