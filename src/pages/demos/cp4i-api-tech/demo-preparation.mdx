...
| Purpose Description  | If you are doing the L3 course, enter: **CP4I L3 Course**. <br/> If you are delivering a Demo, enter the Demo details.  |
...
2.4 You will receive a second email once the environment is provisioned. You should expect this to take between 30 and 120 minutes. Now the status update changed to **Ready**.  Click on **Reservation ID** to open the details page of your new reservation environment. Copy your **Cluster Admin Username** (A) and **Cluster Admin Password** (B). Copy the **OCP Console link** (C).
...
12.1	Back to the Platform Navigator page (If necessary log in with your admin *Username* and *Password*).<br/><img src="images/prep-image210.png" width="800" /><br/>
...
12.3 Click on the **ace-designer-ai** entry. <br/><img src="images/prep-44-2.png" width="800" /><br/>
...
12.6 Enter your Salesforce **Login URL**.

<InlineNotification kind="info-square">You must enter <strong>‘https://’</strong> in front of the Saleforce Login URL you saved earlier. The connection will not work if you just copy/paste the hostname.</InlineNotification>

<br/><img src="images/Prep4.6.png" width="800" />
...
13.1 Open the CP4I homepage (if necessary, click on *Home* icon on the top of the page). On the homepage, you should see the all instances available on your Pak. Select **asset-repo-ai**.<br/><img src="images/asset-repo-100.png" width="800" /><br/>

13.2 Click **Remotes** (1) and select **Add remote** (2). <br/><img src="images/asset-repo-110.png" width="800" /><br/>

13.3 Fill in the following values.
...
Now, let's create a user in the Developer Portal.

14.1 Expand **Design** and select **APIs** (1).<br/><img src="images/prep-image501.png" width="800" /><br/>

14.2 Click **apim-demo** API management. <br/><img src="images/prep-image502.png" width="800" /><br/>

<InlineNotification kind="warning">If necessary accept the connection risks.</InlineNotification>
