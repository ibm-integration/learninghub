...
4.2 Change to the new {{ page.gitHubDir }} directory:
...
8.1 In the menu on the top left, open the **Administration** folder and select **Instances** (2). <br/><img src="images/asset-repo-90.png" width="400" /><br/>

8.2 Select **assetrepo**.<br/><img src="images/asset-repo-100.png" width="800" /><br/>

8.3 Click **Remotes** (1) and select **Add remote** (2). <br/><img src="images/asset-repo-110.png" width="800" /><br/>

8.4 Fill in the following values:<br/>
...
8.5 In a couple of minutes the resources from the GitHub repository will be synchronized.<br/><img src="images/asset-repo-130.png" width="800" /><br/>
