...
| **Action** &nbsp; 2.3.3 | Confirm the instances has been deployed successfully before moving to the next step running the following command. <br/> <pre> oc get pods -n cp4i | grep nginx  </pre> <br/><br/> You should get a response like this. <br/><br/>![](images/uniform-cluster-2-3-3.png)<br/>|
