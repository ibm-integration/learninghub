...
4.3 Open the Catalog settings tab (A). Click Portal (B).
...
4.6 It will take a few minutes to complete the portal creation. Once complete, you will receive an email containing a link to set the password for the portal admin account. You will not admin account in your demo, but feel free to change the password if you desire.
