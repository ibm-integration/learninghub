...
<AnchorLinks>
  ...
  <AnchorLink>10 - Configure Message Queue (IBM MQ) to Authorize and Accept Data</AnchorLink>
  <AnchorLink>11 - Install IBM App Connect Enterprise for Developers (Toolkit)</AnchorLink>
</AnchorLinks>
