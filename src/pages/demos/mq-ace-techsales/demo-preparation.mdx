...
9.4 Now, let's get the mq pods available on OpenShift server. First, let's use the cp4i project.
```
oc project cp4i
```
...
The MQ configuration (channel and security) was updated on your queue manager.
