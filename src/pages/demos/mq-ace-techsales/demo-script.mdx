...
| :--- | :--- |
| **Narration** | Here we have our demo flow. In the flow editor, we can edit and change our flow. Message flows are created in the Toolkit using a drag and drop editor. <br/><br/> The flow is quite simple, consisting of only four nodes: Input, Output, a simple mapping node, and an MQOutput node. |
