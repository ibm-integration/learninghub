...
| **Action** &nbsp; 3.3.3 | Select **ace-mq.zip** (A) file that you downloaded in the Demo Preparation part. Verify **neworder** project is checked (B) and click **Finish** (C). <br/><br/>![](images/ace-toolkit.png)<br/>|
