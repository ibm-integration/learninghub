...
| **Action** &nbsp; 1.1.1 | On a browser window open the <a href="http://www.stepzen.com" target="_blank">URL below (1) and click on **Log In** link (2). <br/><br/>```http://www.stepzen.com```<br/><br/>![](images/setup-sz-2.png)<br/>|
...
| **Action** &nbsp; 1.2.2 | Now, you need to enter your Admin Key. Copy and paste the **Admin Key** value (2) from the Account page.  <br/><br/>![](images/setup-sz-8.pn)<br/>|
