...
11.	GraphQLZero is a free, online GraphQL API that you can use to get fake data from a real backend while testing or prototyping your app.  You will use the GraphQLZero API Playground to test your API. Open the <a href="https://graphqlzero.almansi.me/api" target="_blank">GraphQLZero API Playground</a>. Paste the **API Gateway URL of your API** (1), and enter the Graphql query below (2).
