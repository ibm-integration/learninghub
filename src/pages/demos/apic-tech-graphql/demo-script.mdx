...
import ArticleDetails from '../../../gatsby-theme-carbon/components/InlineNotification'
...
<InlineNotification kind="error" title="Error:" subtitle="Subtitle text goes here" />
