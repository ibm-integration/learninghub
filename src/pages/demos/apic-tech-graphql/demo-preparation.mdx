...
<InlineNotification kind="warning">To install the StepZen CLI, you need to use an adminsitrator user. If you are not using an admin user, you need to execute the command *"su -"* first.</InlineNotification>
