...
| **Notes** | In this course, the terms StepZen and API Connect Essentials are used interchangeably. StepZen was the company IBM acquired, API Connect Essentials is the new name for the product and the terms are at the time of this development being used interchangeably as it is in the CLI and other parts of the software. |
