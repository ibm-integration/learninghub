...
2.1 To create your free StepZen account, open the <a href="https://stepzen.com/signup" target="_blank">page</a> below.
```
https://stepzen.com/signup
```

2.2 Click on **Start for Free**.
![](images/stepzen-free-new-2.png)

2.3 Fill the form (A) and press **Next** (B).
...
3.5 First time, you will see a Welcome to API Connect dialog. You are welcome to explore the options. Feel free to see a **Product overview** (A), if necessary. When done, **close** (B) the Welcome dialog to access the API Connect home screen.
![](images/api-connect-aws-5.png)

3.6 Great, now you are on API Connect home screen. Here you can easily create, manage, secure and socialize APIs. Next section, you will start to use APIC on AWS.
...
To simplify your demo, now you are creating the Developer Portal, to avoid to wait the Portal creation during the demo. Let's do it!
...
4.6 It will take a few minutes to complete the portal creation. Once complete, you will receive an email containing a link to set the password for the portal admin account. You will not use admin account in your demo, but feel free to change the password if you desire.
