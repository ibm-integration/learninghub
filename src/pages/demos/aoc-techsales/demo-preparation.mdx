...
<AnchorLinks>
  ...
  <AnchorLink>7 - Copying Access Key and Secret of your built-in node</AnchorLink>
</AnchorLinks>
...
### 7 - Copying Access Key and Secret of your built-in node
...
7.1 Back to Aspera on Cloud site, open the **App switcher** menu (A) and select **Packages** (B).

![](images/access-key-1.png)

7.2 In **My inbox** view (A), you should have the *Access key information* package from *Tech Support*. Click on **Access key information** package (B).

![](images/access-key-2.png)

7.3 In the **Assets** tab (A), select the **access_key_info.txt** file (B) and click **Download** (C).

![](images/access-key-3.png)

7.4 Open the **Transfer activity** dialog (A) and click on **View local folder** (B).

![](images/access-key-4.png)

7.5 Open the file with a Text editor and copy the **secret**.
