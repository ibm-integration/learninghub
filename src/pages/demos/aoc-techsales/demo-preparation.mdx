...
For the second storage bucket, you will need an acccount in a different Cloud platform. If you don't have one, you can go ahead and create an Azure free account and use its free tier capabilities. However, you will need to enter a valid credit card. It is a temporary authorization and will not charge unless you move to pay-as-you-go subscription. However If you don't want to create a free tier account, because you don't want to enter your <u>credit card</u>, no problem! You can go ahead with this demo and ignore the last section of the demo script (Transfer files between different cloud platforms).
