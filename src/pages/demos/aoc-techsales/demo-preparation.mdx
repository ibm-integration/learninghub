...
6.5 Open the **Instances** menu (A) and select your new **Cloud Object Storage instance** (B).

![](images/6-5-update-2024-1.png)

6.6 Click **Create bucket**.

![](images/6-6-update-2024-1.png)

6.7 Select **Quickly get started** to use a predefined bucket.

![](images/6-7-update-2024-1.png)

6.8 Your IBM Cloud storage must be in a region that is supported by the Aspera on Cloud transfer service. To view the supported regions, check the <a href="https://ats.aspera.io/pub/v1/servers/softlayer" target="_blank">list</a> here.  Check that you are using **us-south** (A) and click **Next** (B).

![](images/icos-8.png)

6.9 **Drag and drop a 50MB file** (A) and click **Next** (B).

![](images/icos-9.png)

6.10 On *Test your bucket* page, click **View bucket configuration** button.

![](images/icos-10.png)

6.11 On the Bucket configuration page, take notes of your Bucket name (A), you will need that during the demo to integrate your ICOS bucket with Aspera on Cloud. On the Breadcrumbs, click on your new **Storage instance** link (B).

![](images/6-11-update-2024-1.png)

6.12 Open the **Service credentials** tab.
...
6.14 Enter **Service credentials-HMAC** as Credential Name (A). Select **Writer** as Role (B). **Turn On** the *Include HMAC Credential* (C). And click **Add** (D).
