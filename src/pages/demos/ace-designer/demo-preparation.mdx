...
3.1 Go to <a href="https://developer.salesforce.com/signup" target="_blank" rel="noreferrer">Salesforce Developers</a>. Follow the prompts on the Saleforce pages to get your free developer account.<br/>
...
3.9 Enter **App Connect** (1) as the **Connect App Name** and your email as the **Contact Email** (2). The API name is automatically generated by Salesforce. Select **Enable OAuth Settings** (3).<br/><img src="images/prep-image3.9.png" width="800" /><br/>
...
5.1	If you haven’t already accessed the App Connect trial (if you are on App Connect trial, go ahead and skip to step 5.4), open your email inbox (that you used to create the App Connect trial account), search for **IBM SaaS** (1), open the ****Your IBM App Connect trial is ready” email (2).
...
5.4 Click on **Catalog** button on the left menu.
