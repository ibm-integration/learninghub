...
Next, you will set up an Insightly account, a cloud-based customer relationship management (CRM) solution.

You will create a trial account that lasts for 15 days. After the trial period, you can migrate your trial account to a free account (with limited users).
