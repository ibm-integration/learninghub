...
<details>
<summary>2.1. Create the flow</summary><br/>
...
4.	From your pre-configured Salesforce connector, select **Contacts > Retrieve contact**.

  ![](images/event-flow-04.png)
...
5.	Next section, you will configure this node. It is time to add the second integration node. Click on the **third plus +** icon (A) and search for **Insightly** (B).

  ![](images/event-flow-05.png)
...
Open **your Insightly** <a href="https://login.insightly.com/" target="_blank">page</a> and log in with your lab user and password.

  ![](images/check-target-0.png)
...
**Narration**
Great, the API is ready, now the Focus team just needs to test the API.
...
Open your Salesforce Dev account <a href="https://login.salesforce.com/" target="_blank">page</a>  and log in with your lab user and password.

  ![](images/check-contact-0.png)
