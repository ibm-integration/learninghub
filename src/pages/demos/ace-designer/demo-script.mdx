...
<br/><br/>
In the second part of the lab, the Focus team will develop an API flow from scratch using a low-code approach. They will learn how easily they can create APIs using App Connect.
<br/><br/>
